function(ajout_clang_format)
    ...
    list(FILTER ALL_CPP_FILES EXCLUDE REGEX "${CMAKE_SOURCE_DIR}/(build|external)/.*")
    ...
    if(CLANG_FORMAT)
        ...
        message(STATUS " Clang Format non trouvé? Veuillez vérifier l'installation")
    endif()
endfunction()
...
function(ajout_cmake_format)
    ...
    list(FILTER ALL_CMAKE_FILES EXCLUDE REGEX "${CMAKE_SOURCE_DIR}/(build|external)/.*")
